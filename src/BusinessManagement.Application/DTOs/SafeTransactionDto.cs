...
public class SafeTransactionDto
{
    ...
    public System.Collections.Generic.List<SafeTransactionPassengerDetailDto> PassengerDetails { get; set; } = new();
}

public class SafeTransactionPassengerDetailDto
{
...
public class CreateSafeTransactionDto
{
    ...
    public System.Collections.Generic.List<Guid>? BookingIds { get; set; }
    public System.Collections.Generic.Dictionary<Guid, decimal>? BookingPayments { get; set; }
    public string? WithdrawalCategory { get; set; }
    ...
    public string? GroupDepositorName { get; set; }
    public string? IndividualDepositorName { get; set; }
}

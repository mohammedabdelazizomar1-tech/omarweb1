...
public class ExternalVisasController : Controller
{
    ...
    private readonly BusinessManagement.Application.Interfaces.IBookingService _bookingService;
    private readonly ILogger<ExternalVisasController> _logger;

    public ExternalVisasController(
        IExternalVisaService visaService,
        BusinessManagement.Application.Interfaces.IBookingService bookingService,
        ILogger<ExternalVisasController> logger)
    {
